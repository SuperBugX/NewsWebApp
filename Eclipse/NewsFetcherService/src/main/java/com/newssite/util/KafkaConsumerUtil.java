...
public final class KafkaConsumerUtil {
	...
	/*
	 	Method returns a list of articles from Apache Kafka when provided with a Kafka topic.
	...
	*/
	...
	public static List<Article> getAllArticlesFromTopic(String kafkaTopic) {

		TopicReaderProcessor<Article> articleTopicReader = new TopicReaderProcessor<Article>(Article.class);
		KafkaConsumerUtil.startOrCreateConsumers(kafkaTopic, new TopicAckMessageListener(articleTopicReader, false), 1,
				KafkaConfig.getArticleConsumerProps());
