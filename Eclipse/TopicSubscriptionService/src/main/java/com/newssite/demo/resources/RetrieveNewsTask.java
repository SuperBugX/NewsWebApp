...
public class RetrieveNewsTask extends TimerTask {
	...
	// Constructors
	public RetrieveNewsTask(@NonNull String kafkaTopic, @NonNull String stompTopic, @NonNull String newsTopic,
			@NonNull NewsTopicFilters filters, @NonNull KafkaTemplate<String, String> kafkaTemplate) {
		super();
	...
	@Override
	public void run() {
		// Send a new special event indicating the microservice has requested for news
		// content from the news fetcher service for a specific STOMP endpoint.
		kafkaTemplate.send(kafkaNewRequestTopic, stompTopic);
		// Invoke the news fetcher service for news content
